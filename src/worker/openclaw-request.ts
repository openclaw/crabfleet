...
export async function readOpenClawRequestSession(
  ...
  // Stable-owner request hashes are the only replay identity. Pre-cutover IDs
  // intentionally conflict instead of reintroducing mutable owner aliases.
  ...
  if (
    ...
    replay.openclaw_request_hash !== requestHash
  ) {
