...
- Fence browser media, clipboard, and file operations to their active desktop, release failed or superseded frames, retain newer folder navigation, and keep quality controls, Disconnect, statistics, and the clipboard usable on narrow screens or when browser storage is blocked; add maintained browser interaction tests.
