...
- Harden the bundled RoyalVNCKit fork across ARD and UltraVNC authentication and parameter validation, composed Unicode keysyms with legacy ASCII scalars, Tight and ZRLE parsing, bounded zlib streams, synchronized color-depth transitions, CopyRect, EOF handling, reconnects, credential cancellation, and cursor channel preservation.
