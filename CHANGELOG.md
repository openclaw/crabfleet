...
- Fence Share This Mac registry cleanup with per-registration ownership tokens so delayed shutdown from an older app process cannot remove a newer desktop host.
